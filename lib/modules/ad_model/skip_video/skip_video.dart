...
class _SkipVideoScreenState extends State<SkipVideoScreen>
  ...
  void _removePay() {
    setState(() {
      if (_counterPay > widget.viewPrice) {
        _counterPay--;
      }
    });
  }
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      DropdownButtonHideUnderline(
                        child: DropdownButtonFormField2(
                          ...
                          decoration: InputDecoration(
                              hintStyle:
                                  customStyle(color: Colors.grey.shade600),
                      ...
                      TextFormField(
                        ...
                        controller: TextEditingController()
                          ..text =
                              dropMaritialController.selectedList.join(','),
                        onTap: () {
                          showDialog(
                            context: context,
                            builder: (_) => DropDownMaritial(),
                          );
                        },
                        readOnly: true,
                        decoration: InputDecoration(
                      ...
                      Wrap(
                          spacing: 6.0,
                          children:
                              List.generate(selectedAreasList.length, (i) {
                            return InputChip(
                              padding: const EdgeInsets.all(2.0),
                              label: Text(selectedAreasList[i],
                                  style: customStyle()),
                              onDeleted: () {
                                setState(() {
                      ...
                      //       bottom: 60.h, top: 60.h, left: 20.w, right: 20.w),
                      //   hideSearch: true,
                      //   items: skipVideoController.areaListData,
                      //   labelStyle: customStyle(),
                      //   label: "Target Areas",
                      //   multiSelectTag: 'areas',
                      //   decoration:
                      //       BoxDecoration(border: Border(bottom: BorderSide())),
                      //   multiSelect: true,
                      //   dropDownMenuItems:
                      //       skipVideoController.areaListData.map((item) {
                      //     return item.name;
                      //   }).toList(),
                      //   onChanged: (value) {
                      //     if (value != null) {
                      //       print(selectedAreasList);
                      //       selectedAreasList = value.map((item) {
                      //         return item.id;
                      //       }).toList();
                      //     } else {
                      ...
                      TextFormField(
                        ...
                        onChanged: (val) {
                          if (int.parse(val) >= widget.viewPrice) {
                            setState(() {
                      ...
                      Text('\u{20B9} ${_counter * _counterDay * _counterPay}.0',
                          style: customStyle()),
                      const Divider(),
                      const SizedBox(height: 10),
                      SizedBox(
                            ...
                            : CLoginButton(
                                ...
                                onTap: () {
                                  if (_formKey.currentState!.validate()) {
                                    if (_currentRangeValues.start.round() !=
                                            0 &&
                                      ...
                                      skipVideoController.saveFirstPageAdModel(
                                          ...
                                          targetUpperAge: _currentRangeValues.end
                                              ...
                                              .toString(),
                                          targetProfessions:
                                              dropProfessController.selectedList
                                                  .join(',')
                                                  .toString(),
                                          targetArea: selectedAreasList
                                              .join(',')
                                              .toString(),
                                          adwatchPerDay:
                                          ...
                                          adSpendPerDay:
                                              "${_counter * _counterDay * _counterPay}",
                                          adModelId: widget.modelId,
                                          adStartDate: startNowController.text
                                              .substring(0, 10),
                                          adTime: startNowController.text
                                              .substring(11, 16),
                                          adEndDate: endController.text
                                              .substring(0, 10),
                                          adEndTime: endController.text
                                              .substring(11, 16),
                                          createdby: LocalPrefs()
                                              .getIntegerPref(key: SharedPreferenceKey.UserId)
                                              .toString(),
                                          onSuccess: () {
                                            Get.to(SkipVideoSecondScreen(
                                                link: widget.link,
                                                des: des ?? "",
                                                location: location ?? "",
                                                gst: gst ?? "",
